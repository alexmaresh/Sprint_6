...
from locators.order_page_locators import OrderPageLocators as locs
...
class OrderPage(BasePage):
    ...
    def set_phone(self, phone):
        self.send_keys(locs.input_phone, phone)
    ...
    def click_next_button(self):
        self.click_element_delay(locs.button_next)

    @allure.step('Появление формы "Про аренду"')
    def waiting_rent_form(self):
        self.find_element_delay(locs.name_form_about_rent)

    @allure.step('Заполнение формы: поле "Дата"')
    def set_date(self, date):
        self.send_keys(locs.calendar_rent_date, date)
        self.send_keys(locs.calendar_rent_date, Keys.ENTER)

    @allure.step("Заполнение формы: выбор срока аренды")
    def set_rent_period(self, rent_period):
        self.click_element_delay(locs.dropdown_rent_period)
    ...
    def set_comment(self, comment):
        self.send_keys(locs.input_comment, comment)
